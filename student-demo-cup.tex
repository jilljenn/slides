...
\begin{frame}
	...
	\end{itemize}
	\end{block}
	\visible<4>{\alert{Trio ELM} -- Concert piano-voix à Japan Expo}
	\end{column}
	\end{columns}
\end{frame}
...
\begin{frame}
	...
	\raisebox{-3.5mm}{\includegraphics[width=1cm]{figures/twitter.png}}\texttt{@jjvie} \hfill \texttt{jjv@lri.fr}
\end{frame}
