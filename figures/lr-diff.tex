...
\foreach \i in {0.5,1.5,...,15.5}{
	\node[black!20] at (\i,0.5) {0};
}
\node at (3.5,0.5) {1};
\node[fill=white] at (3.5,0.5) {1};
%\node at (0.5,3) {$\theta_1$};
\node at (3.5,3) {$\theta_i$};
%\node at (9.5,3) {$\theta_n$};
\draw[decorate,decoration={brace,raise=2pt,amplitude=5pt}] (0,3.5) -- (10,3.5);
\node[above] at (5,4) {user abilities};
\draw[decorate,decoration={brace,raise=2pt,amplitude=5pt}] (10,3.5) -- (16,3.5);
\node[above] at (13,4) {item difficulties};
\node[fill=white] at (13.5,0.5) {1};
%\node at (10.5,3) {$e_1$};
\node at (13.5,3) {$-d_j$};
%\node at (15.5,3) {$e_m$};
\node at (3.5,1.5) {$U_i$};
...
\draw (10,0) -- ++(0,1);
\node at (5,-1) {User one-hot};
% \node at (5,4) {$\theta$};
\node at (13,-1) {Item one-hot};
% \node at (13,4) {$e$};
